...
const NavDropdown = ({ action }: Props) => {
  return (
    <div
      className={
        "absolute z-10 top-[120%] left-0 bg-white shadow w-[250px] rounded "
      }
    >
      ...
      <div
        className="flex items-center py-1 gap-1 px-2 mb-2 cursor-pointer hover:bg-neutral-30"
        onClick={action}
      >
      ...
      <div
        className="flex items-center py-1 gap-1 px-2 cursor-pointer hover:bg-neutral-30"
        onClick={action}
      >
        <NigeraIcon className="w-5" />
        <span className="heading-6-lg text-neutral-150">NGN</span>
