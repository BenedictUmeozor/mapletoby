    ...
    <>
      <div className="md:hidden">
        ...
        <div className="h-[21.875rem] w-[21.875] rounded overflow-hidden mb-4 relative">
          ...
          />
          <div className="absolute caption bg-critical_red-90 py-1 px-3 top-4 text-critical_red-50 right-4">
      ...
      <div className="max-md:hidden flex mb-8 items-center gap-8 h-[35.15rem]">
        ...
        <div className="flex-[2.5] h-full relative rounded-sm overflow-hidden">
          <Image
            src={product16}
            alt="product"
            height={592}
            ...
            className="w-full h-full"
          />
          <div className="absolute heading-6-lg bg-critical_red-90 py-1 px-3 top-4 text-critical_red-50 right-4">
            <span className="font-semibold text-white">8</span> pieces left
          </div>
        </div>

        <div className="flex-[2.5] h-full flex flex-col justify-between p-10 rounded-sm border border-neutral-50 ">
          <div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              ...
              <Link
                href="#"
                className="heading-6-lg text-custom_blue-60 underline"
              >
                View Size Guide
              </Link>
            </div>
          ...
          <div className="flex items-center gap-4">
            <button className="flex-1 flex items-center gap-1 justify-center py-2 text-white bg-shade-120 border border-shade-120 rounded font-semibold heading-5-lg">
              <ShoppingBag className="w-5" />
              Add To Bag
            </button>
            <button className="flex-1 flex items-center gap-1 justify-center py-2 text-shade-120 border border-neutral-40 bg-neutral-40 rounded font-semibold heading-5-lg">
              <WalletIcon className="w-5" />
              Buy Now
            </button>
          </div>
